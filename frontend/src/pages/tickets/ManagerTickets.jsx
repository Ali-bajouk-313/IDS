        ...
        <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
          <div className="mb-5 grid gap-4 lg:grid-cols-4">
            ...
            <input
              ...
              className="w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-700 outline-none transition focus:border-blue-500 focus:bg-white focus:ring-4 focus:ring-blue-100"
            />
            <div className="rounded-3xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-slate-700">{tickets.length} department tickets</div>
          </div>
          ...
          {loading ? (
            <div className="rounded-3xl border border-slate-200 bg-slate-50 p-8 text-center text-sm text-slate-600">Loading department tickets…</div>
          ) : tickets.length === 0 ? (
            <div className="rounded-3xl border border-slate-200 bg-slate-50 p-8 text-center text-sm text-slate-600">No tickets found in your department.</div>
          ) : (
            <DataTable
              columns={["Ticket #", "Employee", "Department", "Priority", "Status", "Actions"]}
              rows={rows}
            />
          )}
        </div>
